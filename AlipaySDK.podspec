...
Pod::Spec.new do |s|
  s.name             = 'AlipaySDK'
  s.version          = '2.0.0'
  s.summary          = 'AlipaySDK. non-offical'
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.source           = { :http => 'http://aopsdkdownload.cn-hangzhou.alipay-pub.aliyun-inc.com/demo/AlipaySDK_No_UTDID.zip?spm=a219a.7629140.0.0.apYeja&file=AlipaySDK_No_UTDID.zip' }
  ...
  s.frameworks = 'SystemConfiguration','Security','CoreTelephony', 'QuartzCore', 'CoreText', 'UIKit', 'CFNetwork', 'Foundation', 'CoreMotion', 'CoreGraphics'
  s.library = 'z', 'c++'
